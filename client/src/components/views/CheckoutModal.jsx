            ...
            {orderConfirmed ? (
              ...
              <>
                        ...
                        <>
                          ...
                          <div className="flex flex-wrap gap-2 pt-1">
                            <button
                              ...
                              className="px-2.5 py-1 rounded-full border border-dashed border-brand bg-brand-soft/40 hover:bg-brand-soft text-[10px] font-bold text-brand transition-colors"
                            >
                              🏷️ WELCOME10 (10% OFF)
                            </button>
                            <button
                              ...
                              className="px-2.5 py-1 rounded-full border border-dashed border-forest/60 bg-forest/5 hover:bg-forest/10 text-[10px] font-bold text-forest transition-colors"
                            >
                              🏷️ AYUSH50 (₹50 OFF)
                            </button>
                            <button
                              ...
                              className="px-2.5 py-1 rounded-full border border-dashed border-sand-border hover:bg-sand text-[10px] font-bold text-charcoal transition-colors"
                            >
                              🏷️ FIBAX15 (15% OFF)
                            </button>
                          </div>
                ...
                <div className="pt-2">
                  <button
                    type="button"
                    disabled={isSubmitting || !isOtpVerified || !fullName.trim() || !street.trim() || !area.trim() || pincode.length !== 6 || !city.trim()}
